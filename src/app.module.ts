...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      synchronize: process.env.NODE_ENV !== 'prod' && process.env.NODE_ENV !== 'test', // Setting synchronize: true shouldn't be used in production - otherwise you can lose production data.
